...
public class GoodSelectedFragment extends Fragment {
    private RecyclerView mRecyclerView;
    private List<User> mUserList;

    public  static GoodSelectedFragment createFragment(){
        GoodSelectedFragment fragment = new GoodSelectedFragment();
        return fragment;
    }
    // 在此阶段可以执行：
    // - 初始化非视图相关的变量
